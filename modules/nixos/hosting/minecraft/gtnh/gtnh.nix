# Reference: https://github.com/Misterio77/Foundry/blob/main/hosts/taygeta/services/minecraft/servers/gtnh/gtnh.nix
...
in stdenvNoCC.mkDerivation {
  ...
  src = fetchzip {
    url = "https://downloads.gtnewhorizons.com/ServerPacks/betas/GT_New_Horizons_2.9.0-beta-2_Server_Java_17-25.zip";
    hash = "sha256-7AAHYUlELt8kZR8quRxIiR+3osgpBWb0sstO6aDBp6U=";
    stripRoot = false;
  };
  ...
  installPhase = ''
    ...
    # Add required files recursively 
    extra_libs="$(find $out/lib/libraries $out/lib/mods -name "*.jar" 2>/dev/null | tr '\n' ':')"
    class_path="$class_path:$extra_libs"
